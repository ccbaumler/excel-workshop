...
- Press `?` for presentation options
- Open the menu in the upper right
- Use arrow keys to navigate easily
...
- open Excel on your device (This course **REQUIRES** a downloaded application of Excel)
...
## Inserting entire columns or rows
...
- Highlight a set of values (a column, row, or matrix)

:::

::: {.r-stack}

![](images/excel-transpose-1.png)

![](images/excel-transpose-2.png){.fragment .disappear-fragment}

![](images/excel-transpose-3.png){.fragment}
